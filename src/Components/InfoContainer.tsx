        ...
        <div style={{ height: "80vh" }}>
          ...
          >
            ...
            <Row>
              ...
              Course Leader for the computer science II class at UNL which is
              helping me to better my understanding of the Java programming
              language. This past summer I had an amazing opportunity to be a
              software development intern at Buildertrend.<p></p>I am the
              secretary and serve on the executive board of Phi Kappa Theta
              ...
              react.ts front-end and a python and django back-end.
            </Row>
            <Row
              className="bodyHeaderFont"
              style={{ height: "40px", textAlign: "left" }}
